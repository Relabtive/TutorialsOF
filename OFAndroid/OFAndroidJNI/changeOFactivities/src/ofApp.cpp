...
Java_cc_openframeworks_changeOFactivities_OFActivity_callCmethod(JNIEnv *, jobject){
...
void ofApp::setupJNI(){
	...
	jclass localClass = env->FindClass("cc/openframeworks/changeOFactivities/OFActivity");
